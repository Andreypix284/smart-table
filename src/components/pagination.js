...
export const initPagination = ({ pages, fromRow, toRow, totalRows }, createPage) => {
    ...
    pages.firstElementChild.remove();                                 // удаляем оригинальный элемент-шаблон
    return (data, state, action) => {
        ...
        if (page < 1) page = 1;                   // страница переменной, потому что она может меняться при обработке действий позже
